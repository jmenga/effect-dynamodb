...
export const condition: {
  (cond: ConditionInput): <T extends ConditionTarget>(self: T) => T
  <T extends ConditionTarget>(self: T, cond: ConditionInput): T
} = Fn.dual(2, <T extends ConditionTarget>(self: T, cond: ConditionInput): T => {
