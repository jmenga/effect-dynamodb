...
const _pipeBadRuntime = Effect.gen(function* () {
  yield* Employees.update({ employeeId: "e-1" }).pipe(Entity.set({ tenantId: "t-3" }))
})
...
const _pipeGood2 = Effect.gen(function* () {
  yield* Employees.update({ employeeId: "e-1" }).pipe(Entity.set({ name: "Alice" }))
})
...
const _entityScopedBad = Effect.gen(function* () {
  yield* Employees.update({ employeeId: "e-1" }).pipe(Employees.set({ tenantId: "t-3" }))
})
...
const _entityScopedGood2 = Effect.gen(function* () {
  yield* Employees.update({ employeeId: "e-1" }).pipe(Employees.set({ name: "Alice" }))
})
...
void _pipeBadRuntime, _pipeGood1, _pipeGood2, _pipeChainPartial, _pipeChainGood
void _refExample, _hashMapExample
void _entityScopedBad, _entityScopedGood1, _entityScopedGood2, _entityScopedChain
