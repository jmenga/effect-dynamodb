...
export type IndexPkInput<TModel extends Schema.Top, TIndexes, K extends keyof TIndexes> = Pick<
  ModelType<TModel>,
  IndexPkComposites<TIndexes, K> & keyof ModelType<TModel>
> &
  Partial<Pick<ModelType<TModel>, IndexSkComposites<TIndexes, K> & keyof ModelType<TModel>>>
