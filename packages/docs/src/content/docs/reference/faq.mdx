...
yield* db.entities.Users.update(
  { userId: "123" },
...
- Pass update combinators (`Entity.set`, `Entity.expectedVersion`, `EntityDef.condition`, etc.) as rest arguments to `db.entities.Users.update` / `.patch`
