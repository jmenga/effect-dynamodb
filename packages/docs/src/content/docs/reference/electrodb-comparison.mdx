...
| Data callback | `.data((attrs, ops) => ...)` | Variadic combinators: `Entity.set()`, `Entity.add()`, `Entity.pathSet()`, etc. | Parity |
| Nested property updates | Dot notation for maps, brackets for lists | Path-based combinators: `Entity.pathSet()`, `Entity.pathRemove()`, `Entity.pathAdd()`, etc. | Parity |
...
| Data callback | Variadic combinators: `Entity.set()`, `Entity.add()`, `Entity.pathSet()`, etc. |
| Nested property updates | Path-based combinators: `Entity.pathSet()`, `Entity.pathRemove()`, `Entity.pathAdd()`, etc. |
