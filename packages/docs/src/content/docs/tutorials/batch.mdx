...
Both entities share a single table. Orders have a GSI collection for querying by user:
...
The complete runnable example is at [`examples/batch.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/tutorials/batch.ts) in the repository.
