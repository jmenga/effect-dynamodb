...
The complete runnable example is at [`examples/hr.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/examples/hr.ts) in the repository. It seeds data, runs all 10 access patterns, and verifies each with assertions.
...
- [Cricket Match Manager](/effect-dynamodb/examples/gamemanager/) — Full end-to-end tutorial building a REST API
