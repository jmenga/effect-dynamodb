...
- [Example: Scan Operations](/effect-dynamodb/examples/scan/) -- Full-table scans with filters, limits, and entity-type isolation
- [Example: Projections](/effect-dynamodb/examples/projections/) -- Selective attribute retrieval with ProjectionExpression
