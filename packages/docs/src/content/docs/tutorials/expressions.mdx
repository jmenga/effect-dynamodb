...
The complete runnable example is at [`examples/expressions.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/examples/expressions.ts) in the repository.
