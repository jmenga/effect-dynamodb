...
The complete runnable example is at [`examples/task-manager.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/examples/task-manager.ts) in the repository. It seeds data, runs all 9 access patterns, and verifies each with assertions.
