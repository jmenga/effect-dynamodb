...
- [Library System](/effect-dynamodb/examples/library-system/) -- Sparse indexes, 4-entity collections, and book loan workflows
- [Human Resources](/effect-dynamodb/examples/human-resources/) -- Full HR system with transfers, termination, and rehire
