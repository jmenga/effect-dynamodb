...
- [Example: Conditional Writes & Filters](/effect-dynamodb/examples/expressions/) -- Conditional puts, updates, deletes, and filter operators
...
- [Example: Human Resources](/effect-dynamodb/examples/human-resources/) -- Full single-table design with 3 entities, collections, and transactions
