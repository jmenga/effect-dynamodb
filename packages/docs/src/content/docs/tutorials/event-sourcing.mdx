...
- [Example: Unique Constraints](/effect-dynamodb/examples/unique-constraints/) — Globally unique fields and idempotency keys
- [Example: Human Resources](/effect-dynamodb/examples/human-resources/) — Single-table design with collections and transactions
