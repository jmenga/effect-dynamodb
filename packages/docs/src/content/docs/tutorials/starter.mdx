...
- [CRUD Operations](/effect-dynamodb/tutorials/crud/) — Deep dive into put, get, update, delete with combinators
- [Indexes & Queries](/effect-dynamodb/guides/indexes/) — Design GSI access patterns with entity-level indexes
- [Expressions](/effect-dynamodb/tutorials/expressions/) — Conditions, filters, and projections
