...
```typescript title="models.ts" region="models" example="updates.ts"
...
```typescript title="entities.ts" region="entities" example="updates.ts"
...
```typescript region="setup" example="updates.ts"
...
```typescript region="add" example="updates.ts"
...
```typescript region="subtract" example="updates.ts"
...
```typescript region="append" example="updates.ts"
...
```typescript region="remove" example="updates.ts"
...
```typescript region="composed" example="updates.ts"
...
```typescript region="locking" example="updates.ts"
...
```typescript title="main.ts" region="run" example="updates.ts"
