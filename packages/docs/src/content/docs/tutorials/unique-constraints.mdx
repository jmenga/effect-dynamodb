...
The complete runnable example is at [`examples/unique-constraints.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/examples/unique-constraints.ts) in the repository.
...
| **Sparse constraints** | Constraints on optional fields skip the sentinel when any composite is unset — see [Data Integrity → Sparse Constraints](/effect-dynamodb/guides/data-integrity/#sparse-constraints) |
