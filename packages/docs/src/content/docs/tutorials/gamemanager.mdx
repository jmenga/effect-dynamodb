...
```bash
pnpm add effect@4.0.0-rc.109 @effect/platform-node@4.0.0-rc.109 effect-dynamodb ulid
pnpm add -D typescript@^5.9.0 tsx vitest@^4.1.0 @effect/vitest@4.0.0-rc.109 @biomejs/biome@^2.4.4
```
