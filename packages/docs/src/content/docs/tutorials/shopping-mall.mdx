...
- [Example: Blog Platform](/effect-dynamodb/examples/blog/) -- Multi-entity single-table design with transactions
- [Example: Human Resources](/effect-dynamodb/examples/human-resources/) -- 3 entities, 5 GSIs, collections, and soft delete
