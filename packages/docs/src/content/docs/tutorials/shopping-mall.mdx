...
description: "Single entity with composite keys, 2 GSI indexes, and date range queries"
---
...
The complete runnable example is at [`examples/shopping-mall.ts`](https://github.com/effect-ts/effect-dynamodb/tree/main/packages/effect-dynamodb/examples/shopping-mall.ts) in the repository. It seeds data, runs all 6 access patterns, and verifies each with assertions.
