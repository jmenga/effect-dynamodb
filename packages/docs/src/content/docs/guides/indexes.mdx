...
- [indexPolicy — Per-Composite GSI Membership Rules](/effect-dynamodb/guides/index-policy/) -- Three-way payload classification (omission / explicit clear / present), sparse/preserve outcomes, hierarchical SK pruning
